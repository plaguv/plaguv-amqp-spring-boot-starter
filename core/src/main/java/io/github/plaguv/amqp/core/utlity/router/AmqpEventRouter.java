...
public class AmqpEventRouter implements EventRouter {
    ...
    @Override
    public String resolveQueue(EventEnvelope eventEnvelope) {
    ...
    @Override
    public String resolveExchange(EventEnvelope eventEnvelope) {
    ...
    @Override
    public String resolveRoutingKey(EventEnvelope eventEnvelope) {
    ...
    @Override
    public Set<String> resolveBindingKey(EventEnvelope eventEnvelope) {
