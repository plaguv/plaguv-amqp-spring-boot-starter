...
public class AmqpEventListenerDiscoverer implements EventListenerDiscoverer {
    ...
    public List<Listener> getListeners() {
        ...
        for (String beanName : factory.getBeanDefinitionNames()) {
            ...
            Map<Method, AmqpEventListener> annotatedMethods = MethodIntrospector.selectMethods(
                    beanClass,
                    (MethodIntrospector.MetadataLookup<AmqpEventListener>) method ->
                            AnnotatedElementUtils.findMergedAnnotation(method, AmqpEventListener.class)
            );
