package io.github.plaguv.amqp.core.utlity.helper;
...
public abstract class ClassNameExtractor {
     ...
     */
    public static String extractUpperLower(Class<?> clazz) {
     ...
     */
    public static String extractUpperLower(Class<?> clazz, char separator) {
